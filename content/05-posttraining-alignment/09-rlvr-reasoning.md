...
!!! sota "State of the Art & Resources (2026)"
    ...
    **Recent advances (2023–2026)**
    ...
    - [Ren et al. (DeepSeek-AI), *DeepSeek-Prover-V2: Advancing Formal Theorem Proving via Reinforcement Learning* (2025)](https://arxiv.org/abs/2504.21801) — trains a Lean 4 prover with expert iteration and RL against the compiler as a binary verifier (the zero-false-positive limit of RLVR); evaluated on miniF2F and PutnamBench. See also DeepMind's AlphaProof (2024), which reached IMO silver-medal level with Lean-based RL.
