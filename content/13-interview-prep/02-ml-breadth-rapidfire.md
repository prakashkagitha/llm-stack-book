...
Running this prints something like `degree= 1  bias^2=0.21  variance=0.01`, `degree= 3  bias^2=0.00  variance=0.02`, `degree= 9  bias^2=0.00  variance=0.30`. The degree-1 line is too stiff (high bias); the degree-9 polynomial wiggles wildly to chase noise (high variance); degree-3 is the sweet spot. **This U-shaped total-error curve is the single most important picture in the breadth round** — the interviewer wants to see you draw it and name the axes.
