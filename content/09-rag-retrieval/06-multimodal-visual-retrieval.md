...
!!! sota "State of the Art & Resources (2026)"
    ...
    **Current models & leaderboards (2026)**
    ...
    - [ViDoRe leaderboard](https://huggingface.co/spaces/vidore/vidore-leaderboard) — the live ranking; ViDoRe-v1 is now saturated near ~89 nDCG@5, so ViDoRe-v2 is the benchmark that separates 2025–2026 systems.
    - [`vidore/colqwen2.5-v0.2`](https://huggingface.co/vidore/colqwen2.5-v0.2) — the Qwen2.5-VL-based late-interaction default (~89 nDCG@5 on ViDoRe-v1), superseding the original PaliGemma ColPali.
    - [`nomic-ai/colnomic-embed-multimodal-7b`](https://huggingface.co/nomic-ai/colnomic-embed-multimodal-7b) — a leading open multimodal late-interaction retriever, strongest on the harder ViDoRe-v2.
