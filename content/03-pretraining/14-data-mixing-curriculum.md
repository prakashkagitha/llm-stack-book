...
!!! sota "State of the Art & Resources (2026)"
    ...
    **Recent advances (2023–2026)**
    ...
    - [Team OLMo, *OLMo 3* (2025)](https://arxiv.org/abs/2512.13961) — fully open 7B/32B model family documenting a three-stage recipe: broad large-scale pretraining, a **mid-training** phase that concentrates math/code/reading-comprehension data, and a long-context extension stage; its Dolma 3 Dolmino mid-training mix (100B tokens sampled from a ~2.2T high-quality pool) is the direct successor to OLMo 2's Dolmino annealing mix. (See also [OLMo 2 (2025)](https://arxiv.org/abs/2501.00656) for the earlier two-stage annealing writeup.)
